...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:3857',
            //extent: [-11877818.975645, 3700649.047347, -11832372.359814, 3735532.631994],
            units: 'm'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-11844430.850825, 3714983.921715, -11841139.059483, 3717451.025374], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Conectividad vial en Ciudad Juarez 2025</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (638 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este visor es un mapa web elaborado en QGIS mediante el complemento Qgis2web. El objetivo es mostrar un proyecto cartográfico que puede publicarse.  Se toma como práctica la siguiente información exploratoria: como mapa base la localidad de Ciudad Juárez; el total de sus vialidades; la intersecciones que se generan en estas vialidades; y los grandes zonas de parques industriales que modifican el patron de la intersección. <br /><br />Para mejor visualización de la información se recomienda un acercamiento a las intersecciones.<br /><br />La información se toma de la base de datos del Instituto Municipal de Investigación y Planeación de Ciudad Juárez.';
            }
